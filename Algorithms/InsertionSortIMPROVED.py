def insertionsort(primArr):
    # UNCOMMENT AND REMOVE FUNCTION FOR INPUTS
        ...
        if unsortedItem < sortedArr[0]:
            ...
            for sortedIndex in range(1, len(sortedArr)):
                if unsortedItem == sortedArr[sortedIndex]:
                    ...
                    break
                if (
                    unsortedItem > sortedArr[sortedIndex - 1]
                    and unsortedItem < sortedArr[sortedIndex]
                ):
                    sortedArr.insert(sortedIndex, unsortedItem)
                    break
